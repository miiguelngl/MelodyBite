            ...
            <div id="header-menu">
                <div class="boton-menu-desplegable">
                    <button class="header-boton" id="header-boton-cerrar">
                        <svg fill="#000000" height="35px" width="35px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 460.775 460.775" xml:space="preserve">
                            <path fill="#fff8ec" d="M285.08,230.397L456.218,59.27c6.076-6.077,6.076-15.911,0-21.986L423.511,4.565c-2.913-2.911-6.866-4.55-10.992-4.55
                ...
                <nav>
                    ...
                    <div class="social-media">
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#fff8ec" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#fff8ec" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                            </svg>
                        </a>
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#fff8ec" class="bi bi-facebook" viewBox="0 0 16 16">
